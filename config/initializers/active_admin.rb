ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Telebras - Contatos"
  ...
  # Nao usa metodo de autenticação
  ...
  # Alteração para autorizacao cancancan gem
  config.on_unauthorized_access = :access_denied
  ...
  # desabilita metodo de verificacao do usuario
  ...
  #
  config.footer = 'TELEBRAS - ERPOA/2019'
